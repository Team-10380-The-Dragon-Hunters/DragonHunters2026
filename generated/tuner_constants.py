...
class TunerConstants:
    ...
    # This needs to be tuned to your individual robot
    speed_at_12_volts: units.meters_per_second = 5.85

    # Every 1 rotation of the azimuth results in _couple_ratio drive motor turns;
    # This may need to be tuned to your individual robot
    _couple_ratio = 3.375

    _drive_gear_ratio = 5.2734375
    ...
    _front_left_encoder_id = 8
    _front_left_encoder_offset: units.rotation = 0.304931640625
    ...
    _front_right_encoder_offset: units.rotation = 0.017578125
    ...
    # Back Left
    _back_left_drive_motor_id = 9
    _back_left_steer_motor_id = 10
    _back_left_encoder_id = 11
    _back_left_encoder_offset: units.rotation = -0.221923828125
    _back_left_steer_motor_inverted = False
    _back_left_encoder_inverted = False

    _back_left_x_pos: units.meter = inchesToMeters(-11) #module offsets
    _back_left_y_pos: units.meter = inchesToMeters(11)

    # Back Right
    _back_right_drive_motor_id = 12
    _back_right_steer_motor_id = 13
    _back_right_encoder_id = 14
    _back_right_encoder_offset: units.rotation = 0.0068359375
